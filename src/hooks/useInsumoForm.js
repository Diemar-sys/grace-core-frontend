...
export default function useInsumoForm({ editItem, onSuccess }) {
  ...
  useEffect(() => {
    ...
    setFormData(prev => ({ ...prev, custom_precio_por_kg: precioPorKg, custom_precio_final: precioFinal }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let msg = err.message || 'Error desconocido al guardar';
