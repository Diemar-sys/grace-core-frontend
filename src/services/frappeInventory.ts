...
class FrappeInventoryService extends FrappeBase {
  ...
  async createItem(formData: ItemForm) {
    ...
    const payload = {
      ...
      custom_precio_de_venta_camioneta: parseFloat(formData.custom_precio_de_venta_camioneta) || null,
      custom_costo_estimado: esProductoTerminado ? (parseFloat(formData.custom_costo_estimado) || null) : null,
