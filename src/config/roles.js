...
export const ROLES = {
  admin: {
    rutas: ['/panel', '/catalogo', '/inventario', '/compras', '/venta-b2b', '/proveedores', '/pos', '/produccion', '/consultas/pos'],
    inicio: '/panel',
    modulosPanel: ['catalogo', 'inventario', 'compras', 'venta_b2b', 'proveedores', 'pos', 'produccion'],
  },
  vendedor: {
